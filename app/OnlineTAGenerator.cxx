...
int main(int argc, char const* argv[]) {
  ...
  std::string tree_tpc_str = "_tpc" + std::to_string(TPC);
  
  TTree *TATree_numu = new TTree(("TATree_numu" + tree_tpc_str).c_str(), "TAs generated by TP threshold.");
  ...
  TTree *TATree_nue = new TTree(("TATree_nue" + tree_tpc_str).c_str(), "TAs generated by TP threshold.");
  ...
  TTree *TATree_cos = new TTree(("TATree_cos" + tree_tpc_str).c_str(), "TAs generated by TP threshold.");
